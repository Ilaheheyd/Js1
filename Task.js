...
function findProductByName(productName) {
    ...
    console.log("Məhsulu düzgün daxil edin !");
}
    ...
    for (let shop of shopGoods) {
        for (let i = 0; i < shop.products.length; i++) {
            if (shop.products[i].product_name === productName) {
                ...
                console.log(productName, "Silindi");
                return;
            }
        }
    }
    ...
    for (let shop of shopGoods) {
        for (let product of shop.products) {
            if (product.product_name === productName) {
                ...
                console.log(productName, " yeni qiymət:", newPrice);
                return;
            }
        }
    }
...
function addNewProduct(newProduct) {
    ...
    console.log("məhsul əlavə edildi:", newProduct.product_name, newProduct.product_description, newProduct.product_price);
}
...
function sortProductsByPrice(order) {
    ...
    console.log("Ardicilliq duzeldi !");
}
...
function showCart() {
    ...
    console.log('Odəniləcək məbləğ: ' + finalPrice);
}

function mainMenu() {
    while (true) {
        let responsibility = prompt('Kimliyinizi daxil edin \n1.admin \n2.muster \n0. proqramdan cixin');

        switch (responsibility) {
            case '1':
                let action = prompt(" əməliyyatı seçin:\n1. Bütün malları göstər\n2. Məhsul axtar\n3. Qiymetleri goster \n4. Məhsul əlavə et\n5. Məhsulu sil\n6. Məhsul qiymətini dəyiş");
                ...
                switch (action) {
                    ...
                    case "3":
                        ...
                        break;
                    case "4":
                        let stIndex = prompt('Magazani secin? \n1.Moda dunyasi \n2. Zerif moda \n3.Əliyev Moda Mərkəzi \nYazi ile daxil edin');
                        let name = prompt('adinidaxil edin');
                        let desc = prompt('xususiyyetlerini daxil edin');
            ...
            case '2':
                ...
                switch (action2) {
                    ...
                    case "3":
                        ...
                        break;
                    case "4":
                        let proName3 = prompt(' mehsulu secin')
                        addToCart(proName3);
                        break;
                    case "5":
                        showCart();
